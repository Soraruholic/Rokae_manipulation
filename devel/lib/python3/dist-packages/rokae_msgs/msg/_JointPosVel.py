...
"""autogenerated by genpy from rokae_msgs/JointPosVel.msg. Do not edit."""
import codecs
import sys
...
class JointPosVel(genpy.Message):
  _md5sum = "deb4fb4efd7a8f0c7867baee56f1a9a5"
  _type = "rokae_msgs/JointPosVel"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# This is for joint postion and velocity accquire.
float64 timestamp
float64[] positions
float64[] velocities"""
  __slots__ = ['timestamp','positions','velocities']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointPosVel, self).__init__(*args, **kwds)
